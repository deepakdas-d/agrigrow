...
import 'package:agrigrow/features/farm/presentation/widgets/motor_health_chart.dart';
...
class _MotorDetailsPageState extends State<MotorDetailsPage> {
  final List<String> _scheduledItems = ["10:00am to 11:00am (daily)"];
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              'Schedule : ${_scheduledItems[index]}',
                              style: const TextStyle(
                                fontSize: 12,
